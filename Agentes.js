...
function actualizarPerfil(sede, filaOriginal, nuevosDatos) {
  try {
    ...
    matrizFila[0][8]  = nuevosDatos.cumpleanos.toString().trim();  // Col I (Índice 8 en Base 0)
    ...
    matrizFila[0][15] = nuevosDatos.genero.toString().trim();    // Col P (Índice 15 en Base 0)
